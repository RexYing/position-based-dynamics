...
/**
 * A static class that builds a Mesh from a specified Wavefront OBJ file. Can
 * throw a FileNotFoundException if the input file does not exist, or a
 * BadMeshException if the OBJ file is malformed. The following must hold, or an
...
public class MeshBuilder {
   ...
   *          The OBJ file.
   * @param ps
   *          The ParticleSystem into which new vertices will be inserted.
   * @return The constructed Mesh.
   */
  public static Mesh buildMesh(File file, ParticleSystem ps)
          throws FileNotFoundException, BadMeshException {
